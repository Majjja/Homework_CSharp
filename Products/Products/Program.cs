...
namespace Products
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            products.Products.AddRange(new List<Product>()
            {
                new Product() { Name = "Mouse", Price = 100, Category = Category.ItEquipment},
            ...
            HelperMethods.GetProductsIds(products.Products);

            HelperMethods.CheapestProduct(products.Products);

            HelperMethods.MostExpensiveProduct(products.Products);

            HelperMethods.AddingProducts(products.Products, "usb", 500, Category.ItEquipment);

            HelperMethods.FilterProductsByPriceRange(products.Products);
